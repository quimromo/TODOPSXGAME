...
.scale = {4000,4000,4000},
.rotation={0, 0, 0}},
{.position = {960,0,2480}, .meshData={.mesh=&obstacle01_Mesh, .texture_tim=_binary_assets_textures_waterTilesetFinal_tim_start},
.scale = {4000,4000,4000},
.rotation={0, 0, 0}},
...
{.center={-1530,0,2130}, .halfSize={-555,706,-302}, .rotation={0,0,0}, .userData=0},
...
{.center={960,0,2710}, .halfSize={-555,706,-302}, .rotation={0,0,0}, .userData=0},
{.center={2400,0,2240}, .halfSize={-555,706,-302}, .rotation={0,0,0}, .userData=0},
{.center={-2780,0,-1790}, .halfSize={-555,706,-302}, .rotation={0,0,0}, .userData=0},
{.center={2490,0,-1790}, .halfSize={-555,706,-302}, .rotation={0,0,0}, .userData=0},
{.center={-1330,0,-1790}, .halfSize={-555,706,-302}, .rotation={0,0,0}, .userData=0}
};
