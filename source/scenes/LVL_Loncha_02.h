...
.rotation={0, 0, 0}},
{.position = {1120,0,2010}, .meshData={.mesh=&obstacle01_Mesh, .texture_tim=_binary_assets_textures_waterTilesetFinal_tim_start},
.scale = {4000,4000,4000},
.rotation={0, 0, 0}},
{.position = {-2750,0,2010}, .meshData={.mesh=&obstacle01_Mesh, .texture_tim=_binary_assets_textures_waterTilesetFinal_tim_start},
.scale = {4000,4000,4000},
.rotation={0, 0, 0}},
{.position = {2610,0,2010}, .meshData={.mesh=&obstacle01_Mesh, .texture_tim=_binary_assets_textures_waterTilesetFinal_tim_start},
.scale = {4000,4000,4000},
.rotation={0, 0, 0}},
...
{.center={2610,0,2240}, .halfSize={-555,706,-302}, .rotation={0,0,0}, .userData=0},
{.center={-380,0,-1790}, .halfSize={-555,706,-302}, .rotation={0,0,0}, .userData=0},
{.center={1070,0,-1790}, .halfSize={-555,706,-302}, .rotation={0,0,0}, .userData=0},
{.center={2490,0,-1790}, .halfSize={-555,706,-302}, .rotation={0,0,0}, .userData=0},
{.center={1120,0,2240}, .halfSize={-555,706,-302}, .rotation={0,0,0}, .userData=0},
{.center={-1320,0,2240}, .halfSize={-555,706,-302}, .rotation={0,0,0}, .userData=0}
};
