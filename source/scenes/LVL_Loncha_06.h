...
{.center={-1700,0,3000}, .halfSize={-636,706,-302}, .rotation={0,0,0}, .userData=0},
{.center={-1700,0,1490}, .halfSize={-636,706,-302}, .rotation={0,0,0}, .userData=0},
{.center={-1700,0,110}, .halfSize={-636,706,-302}, .rotation={0,0,0}, .userData=0},
{.center={-1700,0,-1260}, .halfSize={-636,706,-302}, .rotation={0,0,0}, .userData=0},
{.center={-10,0,2140}, .halfSize={-636,706,-302}, .rotation={0,0,0}, .userData=0},
{.center={-10,0,630}, .halfSize={-636,706,-302}, .rotation={0,0,0}, .userData=0},
{.center={-10,0,-750}, .halfSize={-636,706,-302}, .rotation={0,0,0}, .userData=0},
{.center={-10,0,-2120}, .halfSize={-636,706,-302}, .rotation={0,0,0}, .userData=0}
};
